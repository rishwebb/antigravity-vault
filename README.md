  ...
  <table>
    <tr>
      <td width="50%" align="center">
        ...
        <img src="docs/images/mobile_cloud_tunnel.png" alt="Mobile QR Cloud Tunnel" width="100%" style="border-radius: 8px;" />
      </td>
      <td width="50%" align="center">
        <b>📊 Live Activity Feed & Model Preference Share</b><br><br>
        <img src="docs/images/activity_feed.png" alt="Live Telemetry Activity Feed" width="100%" style="border-radius: 8px;" />
      </td>
    </tr>
  </table>
</div>
...
graph TD
    subgraph Data Sources & Crawlers
        ...
        A2[Deep Historical Scanner<br/>historical_scanner.py<br/>Idempotent Recursive Crawl] --> D
    end

    subgraph Core Engine & Resilience
        D --> E[(Permanent SQLite Vault<br/>antigravity_telemetry.db<br/>WAL Mode & Unique Constraints)]
        F[Backup Vault Engine<br/>backup_engine.py<br/>Daily Snapshots & all_time_archive.json] <--> E
        G[Dynamic Forex Engine<br/>forex.py<br/>Live USD/INR Rate API] --> H[REST API Server<br/>server.py :4848]
        E --> H
    end

    subgraph Access & User Interface
        H --> I[Cloudflare Tunnel / LAN<br/>tunnel.py]
        H --> J[Single Page Dashboard<br/>Mobile Touch + QR Code + PIN Auth]
        I --> K[Mobile / Remote Devices<br/>Free HTTPS Zero Open Ports]
    end
```
